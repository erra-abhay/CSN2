...
import { ArrowLeft, CheckCircle2, ShieldAlert, Loader2, Key, Check, Award, FileText, Database, Shield, Layers, HelpCircle } from "lucide-react";
...
function VerificationContent() {
  ...
  useEffect(() => {
    if (certIdParam && allCerts.length > defaultCerts.length) {
      ...
      // If component mounted and query param exists, search in initial list
      handleVerify(certIdParam);
    }
            ...
            {allCerts.map((c) => (
              ...
              >
                <div className="flex justify-between items-start mb-3">
                  ...
                  <span className="px-1.5 py-0.5 bg-neutral-100 text-neutral-500 rounded-[4px] text-[8px] font-bold uppercase tracking-wider">
                    {c.blockHeight}
                  </span>
                </div>
            ...
            <div>
              ...
              {!loading && !searched && (
                <div className="text-center py-8 text-neutral-500 flex flex-col items-center justify-center gap-2">
                  ...
                  <span>Select any certificate on the left to trigger validation check and logs.</span>
                </div>
              )}
              ...
              {searched && errorMsg && (
                <div className="text-status-red space-y-2 font-semibold">
                  <div className="flex items-center gap-2 text-white border-b border-neutral-850 pb-2 mb-2 uppercase text-[9px] tracking-wider">
                    <ShieldAlert size={12} className="text-status-red" /> Audit Mismatch
                  </div>
