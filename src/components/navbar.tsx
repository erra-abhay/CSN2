    ...
    <header className="fixed top-0 left-0 right-0 z-50">
      <div
        className={`transition-all duration-300 border-b ${
          isScrolled || isOpen
            ? "bg-background/85 backdrop-blur-md border-neutral-200/50 py-3 shadow-sm"
      ...
      {/* Mobile Menu Overlay */}
      {isOpen && (
        <div className="lg:hidden fixed inset-x-0 top-[53px] bottom-0 bg-background/95 backdrop-blur-md z-40 flex flex-col p-6 border-t border-neutral-200/50 overflow-y-auto">
